...
export function ProfileFieldsSection({ values, errors, variant = 'email', profileImage, profileImageError, fileInputRef, openFileDialog, handleProfileFileChange, handleChange }: ProfileFieldsSectionProps) {
  const showProfileTextFields = variant === 'member';
