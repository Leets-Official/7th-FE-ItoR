export const modalStyles = {
  ...
  actionGroup: 'flex items-center gap-0',
  actionButton:
    'flex h-[50px] flex-1 items-center justify-center rounded-[2px] border text-sm font-regular leading-[160%] tracking-[-0.07px] transition-colors',
};
