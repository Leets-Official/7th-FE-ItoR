...
<<<<<<< HEAD
export const textFieldVariants = cva('w-full rounded-md border px-4 py-3 outline-none', {
=======
...
>>>>>>> upstream/최예빈/main
  variants: {
    ...
    state: {
<<<<<<< HEAD
      default: 'border-gray-90 bg-transparent text-gray-56 placeholder:text-gray-78',
=======
